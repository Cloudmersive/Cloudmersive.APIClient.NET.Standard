...
namespace Cloudmersive
{
    ...
    /// </summary>
    public partial class ExtractEntitiesString : IServiceOperations<CloudmersiveClient>, IExtractEntitiesString
    {
        /// <summary>
        /// Initializes a new instance of the ExtractEntitiesString class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        public ExtractEntitiesString(CloudmersiveClient client)
        {
            if (client == null) 
            {
        ...
        public async Task<HttpOperationResponse<PostOKResponse>> PostWithHttpMessagesAsync(string value, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "nlp/ExtractEntitiesString").ToString();
