...
namespace Cloudmersive
{
    ...
    /// Scan operations.
    /// </summary>
    public partial class Scan : IServiceOperations<CloudmersiveClient>, IScan
    {
        /// <summary>
        ...
        /// </param>
        public Scan(CloudmersiveClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<FileOKResponse>> FileWithHttpMessagesAsync(System.IO.Stream inputFile, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (inputFile == null)
            {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "virus/scan/file").ToString();
            ...
            // Create Result
            var _result = new HttpOperationResponse<FileOKResponse>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<FileOKResponse>(_responseContent, this.Client.DeserializationSettings);
                }
