...
namespace Cloudmersive
{
    ...
    /// </summary>
    public partial class PosTaggerJson : IServiceOperations<CloudmersiveClient>, IPosTaggerJson
    {
        /// <summary>
        /// Initializes a new instance of the PosTaggerJson class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        public PosTaggerJson(CloudmersiveClient client)
        {
            if (client == null) 
            {
        ...
        /// </return>
        public async Task<HttpOperationResponse<PostOKResponse>> PostWithHttpMessagesAsync(Request request, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (request == null)
            {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "nlp/PosTaggerJson").ToString();
